...
namespace CivilFX.Generic2
{
    ...
    public class CameraController : MonoBehaviour
    {
        ...
        private void ProcessMouseInput()
        {
            ...
            {
                //scroll up
                pinch = cameraTransform.forward * mouseZoomSpeed;
            }
        ...
        private void ProcessKeyboardInput()
        {
            ...
            {
                UnHookView(true);
                transform.Translate(new Vector3(panSpeed * 100f * (Time.deltaTime / Time.timeScale), 0, 0));
            }
            ...
            {
                transform.Translate(new Vector3(0, -panSpeed * 100f * (Time.deltaTime / Time.timeScale), 0));
            }
