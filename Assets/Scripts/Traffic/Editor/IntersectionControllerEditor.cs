    ...
    public class IntersectionControllerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            */
            ...
            //stop sign bool
            currentProp = so.FindProperty("isStopSign");
            EditorGUILayout.PropertyField(currentProp);


            // path to cross if intersection controller is stop sign
            currentProp = so.FindProperty("pathToCross");
            EditorGUILayout.PropertyField(currentProp);

            // the amount of lanes that vehicle will be crossing
            currentProp = so.FindProperty("numLanesToCross");
            EditorGUILayout.PropertyField(currentProp);
