...
namespace CivilFX.TrafficV5
{
    ...
    public class TrafficControllerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            ShowProperty("objTemplate");
            ShowProperty("selectedColor");
            ShowProperty("deselectedColor");
            EditorGUILayout.Space();


            // Diverge Visualization
            ShowProperty("divergeObjTemplate");
            ShowProperty("divergeSelectedColor");
            ShowProperty("divergeDeselectedColor");
            EditorGUILayout.Space();
